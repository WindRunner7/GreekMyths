...
/**
 * PegasasModel - Wind__Runner
 * Created using Tabula 8.0.0
 */
@Mod.EventBusSubscriber(modid = GreekMyths.MOD_ID, value = Dist.CLIENT)
public class PegasusModel<T extends PegasusEntity> extends AgeableModel<T> {
    ...
    public ModelRenderer WingRightMain;
    public ModelRenderer WingLeftMain;
    public ModelRenderer RightWingTip;
    public ModelRenderer RightWingMainFeather;
    public ModelRenderer RightWingTipFeather;
    public ModelRenderer LeftWingTip;
    public ModelRenderer LeftWingMainFeather;
    public ModelRenderer LeftWingTipFeather;

    public PegasusModel(float p_i51065_1_) {
        super(true, 16.2F, 1.36F, 2.7272F, 2.0F, 20.0F);
        this.textureWidth = 128;
        this.textureHeight = 64;
        this.RightWingTip = new ModelRenderer(this, 64, 10);
        this.RightWingTip.setRotationPoint(-15.0F, 0.25F, 0.25F);
        this.RightWingTip.addBox(-10.0F, 0.0F, 0.0F, 10.0F, 1.5F, 1.5F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RightWingTip, 0.0F, 0.17453292519943295F, -0.5235987755982988F);
        this.RightWingMainFeather = new ModelRenderer(this, 64, 15);
        this.RightWingMainFeather.mirror = true;
        this.RightWingMainFeather.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.RightWingMainFeather.addBox(-15.0F, 0.5F, 0.5F, 15.0F, 0.0F, 15.0F, 0.0F, 0.0F, 0.0F);
        this.WingLeftMain = new ModelRenderer(this, 64, 0);
        this.WingLeftMain.setRotationPoint(3.5F, -8.0F, -14.0F);
        this.WingLeftMain.addBox(0.0F, 0.0F, 0.0F, 15.0F, 2.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(WingLeftMain, -0.6108652381980153F, -1.2217304763960306F, -1.1344640137963142F);
        this.LeftWingTipFeather = new ModelRenderer(this, 64, 35);
        this.LeftWingTipFeather.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.LeftWingTipFeather.addBox(0.0F, 0.25F, 0.25F, 10.0F, 0.0F, 15.0F, 0.0F, 0.0F, 0.0F);
        this.RightWingTipFeather = new ModelRenderer(this, 64, 35);
        this.RightWingTipFeather.mirror = true;
        this.RightWingTipFeather.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.RightWingTipFeather.addBox(-10.0F, 0.25F, 0.25F, 10.0F, 0.0F, 15.0F, 0.0F, 0.0F, 0.0F);
        this.LeftWingMainFeather = new ModelRenderer(this, 64, 15);
        this.LeftWingMainFeather.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.LeftWingMainFeather.addBox(0.0F, 0.5F, 0.5F, 15.0F, 0.0F, 15.0F, 0.0F, 0.0F, 0.0F);
        this.WingRightMain = new ModelRenderer(this, 64, 0);
        this.WingRightMain.setRotationPoint(-3.5F, -8.0F, -14.0F);
        this.WingRightMain.addBox(-15.0F, 0.0F, 0.0F, 15.0F, 2.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(WingRightMain, -0.6108652381980153F, 1.2217304763960306F, 1.1344640137963142F);
        this.LeftWingTip = new ModelRenderer(this, 64, 10);
        this.LeftWingTip.setRotationPoint(15.0F, 0.25F, 0.25F);
        this.LeftWingTip.addBox(0.0F, 0.0F, 0.0F, 10.0F, 1.5F, 1.5F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LeftWingTip, 0.0F, -0.17453292519943295F, 0.5235987755982988F);
        ...
        this.WingRightMain.addChild(this.RightWingTip);
        this.WingRightMain.addChild(this.RightWingMainFeather);
        this.body.addChild(this.WingLeftMain);
        this.body.addChild(this.WingRightMain);
        this.LeftWingTip.addChild(this.LeftWingTipFeather);
        this.RightWingTip.addChild(this.RightWingTipFeather);
        this.WingLeftMain.addChild(this.LeftWingMainFeather);
        this.WingLeftMain.addChild(this.LeftWingTip);
    ...
    public void setLivingAnimations(T entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
        ...
        float grassEatingAmount = entityIn.getGrassEatingAmount(partialTick);
        float rearingAmount = entityIn.getRearingAmount(partialTick);
        float negRearingAmount = 1.0F - rearingAmount;
        float mouthOpennessAngle = entityIn.getMouthOpennessAngle(partialTick);
        float flapRearingAmount = entityIn.getFlapAmountRearing(partialTick);
        float negFlapRearingAmount = 1f - flapRearingAmount;
        float flapAmount = entityIn.getFlapAmount(partialTick);
        float negFlapAmount = 1f - flapAmount;
        boolean tailCounterNotZero = entityIn.tailCounter != 0;
...
//            this.field_228265_i_.rotationPointZ = this.field_228264_h_.rotationPointZ;
            ...
            this.head.rotationPointY = rearingAmount * -4.0F + grassEatingAmount * 11.0F + (1.0F - Math.max(rearingAmount, grassEatingAmount)) * this.head.rotationPointY;
        ...
        float f13 = (1.0F - Math.max(rearingAmount, grassEatingAmount)) * (((float) Math.PI / 6F) + f4 + mouthOpennessAngle * MathHelper.sin(f9) * 0.05F);
        this.head.rotateAngleX = rearingAmount * (0.2617994F + f4) + grassEatingAmount * (2.1816616F + MathHelper.sin(f9) * 0.05F) + f13;
        this.head.rotateAngleY = rearingAmount * f3 * ((float) Math.PI / 180F) + (1.0F - Math.max(rearingAmount, grassEatingAmount)) * this.head.rotateAngleY;

        this.body.rotateAngleX = rearingAmount * (-(float) Math.PI / 4F) + negRearingAmount * this.body.rotateAngleX;
        float f14 = 0.2617994F * rearingAmount;
        float f15 = MathHelper.cos(f9 * 0.6F + (float) Math.PI);

        float f16 = ((-(float) Math.PI / 3F) + f15) * rearingAmount + f12 * negRearingAmount;
        float f17 = ((-(float) Math.PI / 3F) - f15) * rearingAmount - f12 * negRearingAmount;
        this.field_228262_f_.rotateAngleX = f14 - f11 * 0.5F * limbSwingAmount * negRearingAmount;
        this.field_228263_g_.rotateAngleX = f14 + f11 * 0.5F * limbSwingAmount * negRearingAmount;
        ...
        if (entityIn.isRearing() || entityIn.isHorseJumping()) {
            ...
            } else if (flapRearingAmount < 0.85) {
                setRotateAngle(WingLeftMain, (-5) * (float) Math.PI / 180F, 0, (0 - 5 + 35 * MathHelper.sin((float) ((1030f * (flapRearingAmount - 0.15)) * Math.PI / 180F))) * (float) Math.PI / 180F);
                setRotateAngle(WingRightMain, (-5) * (float) Math.PI / 180F, 0, (5 - 35 * MathHelper.sin((float) ((1030f * (flapRearingAmount - 0.15)) * Math.PI / 180F))) * (float) Math.PI / 180F);
            } else if (flapRearingAmount <= 1) {
                setRotateAngle(WingLeftMain, (0 - 35f + (200 * negFlapRearingAmount)) * (float) Math.PI / 180F, (float) (0 - 70f + (negFlapRearingAmount * 460)) * (float) Math.PI / 180F, (0 - 65f + (400f * negFlapRearingAmount)) * (float) Math.PI / 180F);
                setRotateAngle(WingRightMain, (0 - 35f + (200 * negFlapRearingAmount)) * (float) Math.PI / 180F, (float) (70f - (negFlapRearingAmount * 460)) * (float) Math.PI / 180F, (65f - (400f * negFlapRearingAmount)) * (float) Math.PI / 180F);
            }
        } else if (entityIn.isFlying()) {
            if (entityIn.getFlightBoost()) {
                setRotateAngle(WingLeftMain, (-5) * (float) Math.PI / 180F, 0, (0 - 5 + 35 * MathHelper.sin((float) (1030f * flapAmount * Math.PI / 180F))) * (float) Math.PI / 180F);
                setRotateAngle(WingRightMain, (-5) * (float) Math.PI / 180F, 0, (5 - 35 * MathHelper.sin((float) (1030f * flapAmount * Math.PI / 180F))) * (float) Math.PI / 180F);
            } else {
                setRotateAngle(WingLeftMain, (-5) * (float) Math.PI / 180F, 0, (0 - 5 + 5 * MathHelper.sin((float) (257f * flapAmount * Math.PI / 180F))) * (float) Math.PI / 180F);
                setRotateAngle(WingRightMain, (-5) * (float) Math.PI / 180F, 0, (5 - 5 * MathHelper.sin((float) (257f * flapAmount * Math.PI / 180F))) * (float) Math.PI / 180F);
            }
