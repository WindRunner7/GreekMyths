...
public class LabyrinthJigsawManager {
    ...
    public static void func_242837_a(DynamicRegistries p_242837_0_, VillageConfig p_242837_1_, LabyrinthJigsawManager.IPieceFactory p_242837_2_, ChunkGenerator p_242837_3_, TemplateManager p_242837_4_, BlockPos p_242837_5_, List<? super AbstractVillagePiece> p_242837_6_, Random p_242837_7_, boolean p_242837_8_, boolean p_242837_9_) {
        ...
        if (p_242837_1_.func_236534_a_() > 0) {
            ...
            LabyrinthJigsawManager.Assembler jigsawmanager$assembler = new LabyrinthJigsawManager.Assembler(mutableregistry, p_242837_1_.func_236534_a_(), p_242837_2_, p_242837_3_, p_242837_4_, p_242837_6_, p_242837_7_);
            jigsawmanager$assembler.availablePieces.addLast(new LabyrinthJigsawManager.Entry(abstractvillagepiece, new MutableObject<>(VoxelShapes.combineAndSimplify(VoxelShapes.create(axisalignedbb), VoxelShapes.create(AxisAlignedBB.toImmutable(mutableboundingbox)), IBooleanFunction.ONLY_FIRST)), k + 80, 0));

            while(!jigsawmanager$assembler.availablePieces.isEmpty()) {
                LabyrinthJigsawManager.Entry jigsawmanager$entry = jigsawmanager$assembler.availablePieces.removeFirst();
    ...
    public static void func_242838_a(DynamicRegistries p_242838_0_, AbstractVillagePiece p_242838_1_, int p_242838_2_, LabyrinthJigsawManager.IPieceFactory p_242838_3_, ChunkGenerator p_242838_4_, TemplateManager p_242838_5_, List<? super AbstractVillagePiece> p_242838_6_, Random p_242838_7_) {
        MutableRegistry<JigsawPattern> mutableregistry = p_242838_0_.getRegistry(Registry.JIGSAW_POOL_KEY);
        LabyrinthJigsawManager.Assembler jigsawmanager$assembler = new LabyrinthJigsawManager.Assembler(mutableregistry, p_242838_2_, p_242838_3_, p_242838_4_, p_242838_5_, p_242838_6_, p_242838_7_);
        jigsawmanager$assembler.availablePieces.addLast(new LabyrinthJigsawManager.Entry(p_242838_1_, new MutableObject<>(VoxelShapes.INFINITY), 0, 0));
    ...
    static final class Assembler {
        ...
        private final LabyrinthJigsawManager.IPieceFactory pieceFactory;
        private final ChunkGenerator chunkGenerator;
        private final TemplateManager templateManager;
        private final List<? super AbstractVillagePiece> structurePieces;
        private final Random rand;
        private final Deque<LabyrinthJigsawManager.Entry> availablePieces = Queues.newArrayDeque();

        private Assembler(Registry<JigsawPattern> p_i242005_1_, int p_i242005_2_, LabyrinthJigsawManager.IPieceFactory p_i242005_3_, ChunkGenerator p_i242005_4_, TemplateManager p_i242005_5_, List<? super AbstractVillagePiece> p_i242005_6_, Random p_i242005_7_) {
            ...
            for(Template.BlockInfo template$blockinfo : jigsawpiece.getJigsawBlocks(this.templateManager, blockpos, rotation, this.rand)) {
                ...
                if (optional.isPresent() && (optional.get().getNumberOfPieces() != 0 || Objects.equals(resourcelocation, JigsawPatternRegistry.field_244091_a.getLocation()))) {
                    ...
                    if (optional1.isPresent() && (optional1.get().getNumberOfPieces() != 0 || Objects.equals(resourcelocation1, JigsawPatternRegistry.field_244091_a.getLocation()))) {
                                    ...
                                    if (JigsawBlock.hasJigsawMatch(template$blockinfo, template$blockinfo1)) {
                                        ...
                                        if (!VoxelShapes.compare(mutableobject1.getValue(), VoxelShapes.create(AxisAlignedBB.toImmutable(mutableboundingbox3).shrink(0.25D)), IBooleanFunction.ONLY_SECOND)) {
                                            ...
                                            if (p_236831_4_ + 1 <= this.maxDepth) {
                                                this.availablePieces.addLast(new LabyrinthJigsawManager.Entry(abstractvillagepiece, mutableobject1, l, p_236831_4_ + 1));
                                            }
                                            continue label139;
                                        }
                                    }
                        ...
                        LabyrinthJigsawManager.LOGGER.warn("Empty or none existent fallback pool: {}", (Object)resourcelocation1);
                    }
                } else {
                    LabyrinthJigsawManager.LOGGER.warn("Empty or none existent pool: {}", (Object)resourcelocation);
                }
            }
