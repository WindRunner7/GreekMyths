...
public class LabyrinthChunkStructure extends Structure<NoFeatureConfig> {
    public LabyrinthChunkStructure(Codec<NoFeatureConfig> codec) {
        super(codec);
    }
    ...
    public Structure.IStartFactory<NoFeatureConfig> getStartFactory() {
        return LabyrinthChunkStructure.Start::new;
    }
...
//    }
    ...
    public static class Start extends StructureStart<NoFeatureConfig> {
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            LabyrinthJigsawManager.func_242837_a(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            ...
                            .getOrDefault(new ResourceLocation(GreekMyths.MOD_ID, "labyrinth_chunk/start_pool")),
...
//            this.components.forEach(piece -> piece.getBoundingBox().minY -= 1);
            ...
            GreekMyths.LOGGER.log(Level.DEBUG, "Greek Camp at " +
